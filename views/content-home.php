          ...
          <section class="row grid section-subscribe">
            ...
            <div class="cold-md-12 col-row">
              ...
              <div class="share-project">
                <a href="#" onclick="javascript:window.open('https://www.facebook.com/sharer/sharer.php?u=http://numundo.org', '_blank', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=400,width=550,left=150,top=15   0');return false;" title="Share on Facebook"><button class="btn btn-red" type="button"><i class="fa fa-facebook"></i> Facebook</button></a>
                <a href="#" onclick="javascript:window.open('https://twitter.com/share?text=Discover%20transformational%20travel%20experiences%20with%20NuMundo&url=http://numundo.org', '_blank', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=250,width=600,left=100,top=100');return false;" title="Share on Twitter" target="_blank"><button class="btn btn-red" type="button"><i class="fa fa-twitter"></i> Twitter</button></a>
              </div>
